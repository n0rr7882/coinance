...
import { POLONIEX_API_ENTRY_POINT, FIRST_BITCOIN_ISSUED_TIMESTAMP } from '../constants';
...
const getChartOpton = (currencyPair: CurrencyPair, chartType: ChartType) => {
  const chartTypeOptionMap = {
    [ChartType.full]: new ChartOption(ChartPeriod.hours24, FIRST_BITCOIN_ISSUED_TIMESTAMP, nowTimestamp()),
